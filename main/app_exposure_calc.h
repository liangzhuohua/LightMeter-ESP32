...
static const float APERTURES_1_3[] = {
    0.70f, 0.80f, 0.90f, 0.95f, 
    1.0f,  1.1f,  1.2f,  1.4f,  1.6f,  1.8f,
    2.0f,  2.2f,  2.5f,  2.8f,  3.2f,  3.5f,
    4.0f,  4.5f,  5.0f,  5.6f,  6.3f,  7.1f,
    8.0f,  9.0f, 10.0f, 11.0f, 13.0f, 14.0f,
    16.0f, 18.0f, 20.0f, 22.0f, 25.0f, 29.0f,
    32.0f, 36.0f, 40.0f, 45.0f, 51.0f, 57.0f,
    64.0f, 72.0f, 80.0f, 91.0f
};
...
enum {
    ...
    EXPOSURE_LANDSCAPE,         // 风光模式
    EXPOSURE_PORTRAIT           // 人像模式
};

// 常量定义
const float INCIDENT_CAL = 2.5f;
